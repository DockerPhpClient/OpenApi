...
class HostConfigNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Docker\\OpenAPI\\Model\\HostConfig';
    }

    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'Docker\\OpenAPI\\Model\\HostConfig';
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\OpenAPI\Model\HostConfig();
        ...
        if (\array_key_exists('BlkioWeightDevice', $data) && $data['BlkioWeightDevice'] !== null) {
            ...
            foreach ($data['BlkioWeightDevice'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'Docker\\OpenAPI\\Model\\ResourcesBlkioWeightDeviceItem', 'json', $context);
            }
        ...
        if (\array_key_exists('BlkioDeviceReadBps', $data) && $data['BlkioDeviceReadBps'] !== null) {
            ...
            foreach ($data['BlkioDeviceReadBps'] as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, 'Docker\\OpenAPI\\Model\\ThrottleDevice', 'json', $context);
            }
        ...
        if (\array_key_exists('BlkioDeviceWriteBps', $data) && $data['BlkioDeviceWriteBps'] !== null) {
            ...
            foreach ($data['BlkioDeviceWriteBps'] as $value_2) {
                $values_2[] = $this->denormalizer->denormalize($value_2, 'Docker\\OpenAPI\\Model\\ThrottleDevice', 'json', $context);
            }
        ...
        if (\array_key_exists('BlkioDeviceReadIOps', $data) && $data['BlkioDeviceReadIOps'] !== null) {
            ...
            foreach ($data['BlkioDeviceReadIOps'] as $value_3) {
                $values_3[] = $this->denormalizer->denormalize($value_3, 'Docker\\OpenAPI\\Model\\ThrottleDevice', 'json', $context);
            }
        ...
        if (\array_key_exists('BlkioDeviceWriteIOps', $data) && $data['BlkioDeviceWriteIOps'] !== null) {
            ...
            foreach ($data['BlkioDeviceWriteIOps'] as $value_4) {
                $values_4[] = $this->denormalizer->denormalize($value_4, 'Docker\\OpenAPI\\Model\\ThrottleDevice', 'json', $context);
            }
        ...
        if (\array_key_exists('Devices', $data) && $data['Devices'] !== null) {
            ...
            foreach ($data['Devices'] as $value_5) {
                $values_5[] = $this->denormalizer->denormalize($value_5, 'Docker\\OpenAPI\\Model\\DeviceMapping', 'json', $context);
            }
        ...
        if (\array_key_exists('DeviceRequests', $data) && $data['DeviceRequests'] !== null) {
            ...
            foreach ($data['DeviceRequests'] as $value_7) {
                $values_7[] = $this->denormalizer->denormalize($value_7, 'Docker\\OpenAPI\\Model\\DeviceRequest', 'json', $context);
            }
        ...
        if (\array_key_exists('Ulimits', $data) && $data['Ulimits'] !== null) {
            ...
            foreach ($data['Ulimits'] as $value_8) {
                $values_8[] = $this->denormalizer->denormalize($value_8, 'Docker\\OpenAPI\\Model\\ResourcesUlimitsItem', 'json', $context);
            }
        ...
        if (\array_key_exists('LogConfig', $data) && $data['LogConfig'] !== null) {
            $object->setLogConfig($this->denormalizer->denormalize($data['LogConfig'], 'Docker\\OpenAPI\\Model\\HostConfigLogConfig', 'json', $context));
        ...
        if (\array_key_exists('PortBindings', $data) && $data['PortBindings'] !== null) {
            ...
            foreach ($data['PortBindings'] as $key => $value_10) {
                ...
                foreach ($value_10 as $value_11) {
                    $values_11[] = $this->denormalizer->denormalize($value_11, 'Docker\\OpenAPI\\Model\\PortBinding', 'json', $context);
                }
        ...
        if (\array_key_exists('RestartPolicy', $data) && $data['RestartPolicy'] !== null) {
            $object->setRestartPolicy($this->denormalizer->denormalize($data['RestartPolicy'], 'Docker\\OpenAPI\\Model\\RestartPolicy', 'json', $context));
        ...
        if (\array_key_exists('Mounts', $data) && $data['Mounts'] !== null) {
            ...
            foreach ($data['Mounts'] as $value_13) {
                $values_13[] = $this->denormalizer->denormalize($value_13, 'Docker\\OpenAPI\\Model\\Mount', 'json', $context);
            }
