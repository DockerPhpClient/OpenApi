...
class MountVolumeOptionsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Docker\\OpenAPI\\Model\\MountVolumeOptions';
    }

    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'Docker\\OpenAPI\\Model\\MountVolumeOptions';
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\OpenAPI\Model\MountVolumeOptions();
        ...
        if (\array_key_exists('DriverConfig', $data) && $data['DriverConfig'] !== null) {
            $object->setDriverConfig($this->denormalizer->denormalize($data['DriverConfig'], 'Docker\\OpenAPI\\Model\\MountVolumeOptionsDriverConfig', 'json', $context));
