...
class NodeDescriptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Docker\\OpenAPI\\Model\\NodeDescription';
    }

    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'Docker\\OpenAPI\\Model\\NodeDescription';
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\OpenAPI\Model\NodeDescription();
        ...
        if (\array_key_exists('Platform', $data) && $data['Platform'] !== null) {
            $object->setPlatform($this->denormalizer->denormalize($data['Platform'], 'Docker\\OpenAPI\\Model\\Platform', 'json', $context));
        ...
        if (\array_key_exists('Resources', $data) && $data['Resources'] !== null) {
            $object->setResources($this->denormalizer->denormalize($data['Resources'], 'Docker\\OpenAPI\\Model\\ResourceObject', 'json', $context));
        ...
        if (\array_key_exists('Engine', $data) && $data['Engine'] !== null) {
            $object->setEngine($this->denormalizer->denormalize($data['Engine'], 'Docker\\OpenAPI\\Model\\EngineDescription', 'json', $context));
        ...
        if (\array_key_exists('TLSInfo', $data) && $data['TLSInfo'] !== null) {
            $object->setTLSInfo($this->denormalizer->denormalize($data['TLSInfo'], 'Docker\\OpenAPI\\Model\\TLSInfo', 'json', $context));
