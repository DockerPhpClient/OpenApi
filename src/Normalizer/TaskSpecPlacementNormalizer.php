...
class TaskSpecPlacementNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Docker\\OpenAPI\\Model\\TaskSpecPlacement';
    }

    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'Docker\\OpenAPI\\Model\\TaskSpecPlacement';
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\OpenAPI\Model\TaskSpecPlacement();
        ...
        if (\array_key_exists('Preferences', $data) && $data['Preferences'] !== null) {
            ...
            foreach ($data['Preferences'] as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, 'Docker\\OpenAPI\\Model\\TaskSpecPlacementPreferencesItem', 'json', $context);
            }
        ...
        if (\array_key_exists('Platforms', $data) && $data['Platforms'] !== null) {
            ...
            foreach ($data['Platforms'] as $value_2) {
                $values_2[] = $this->denormalizer->denormalize($value_2, 'Docker\\OpenAPI\\Model\\Platform', 'json', $context);
            }
