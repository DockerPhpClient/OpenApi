...
class ContainerSummaryItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Docker\\OpenAPI\\Model\\ContainerSummaryItem';
    }

    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'Docker\\OpenAPI\\Model\\ContainerSummaryItem';
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\OpenAPI\Model\ContainerSummaryItem();
        ...
        if (\array_key_exists('Ports', $data) && $data['Ports'] !== null) {
            ...
            foreach ($data['Ports'] as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, 'Docker\\OpenAPI\\Model\\Port', 'json', $context);
            }
        ...
        if (\array_key_exists('HostConfig', $data) && $data['HostConfig'] !== null) {
            $object->setHostConfig($this->denormalizer->denormalize($data['HostConfig'], 'Docker\\OpenAPI\\Model\\ContainerSummaryItemHostConfig', 'json', $context));
        ...
        if (\array_key_exists('NetworkSettings', $data) && $data['NetworkSettings'] !== null) {
            $object->setNetworkSettings($this->denormalizer->denormalize($data['NetworkSettings'], 'Docker\\OpenAPI\\Model\\ContainerSummaryItemNetworkSettings', 'json', $context));
        ...
        if (\array_key_exists('Mounts', $data) && $data['Mounts'] !== null) {
            ...
            foreach ($data['Mounts'] as $value_3) {
                $values_3[] = $this->denormalizer->denormalize($value_3, 'Docker\\OpenAPI\\Model\\Mount', 'json', $context);
            }
