...
class SystemDfGetResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Docker\\OpenAPI\\Model\\SystemDfGetResponse200';
    }

    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'Docker\\OpenAPI\\Model\\SystemDfGetResponse200';
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\OpenAPI\Model\SystemDfGetResponse200();
        ...
        if (\array_key_exists('Images', $data) && $data['Images'] !== null) {
            ...
            foreach ($data['Images'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'Docker\\OpenAPI\\Model\\ImageSummary', 'json', $context);
            }
        ...
        if (\array_key_exists('Containers', $data) && $data['Containers'] !== null) {
            ...
            foreach ($data['Containers'] as $value_1) {
                ...
                foreach ($value_1 as $value_2) {
                    $values_2[] = $this->denormalizer->denormalize($value_2, 'Docker\\OpenAPI\\Model\\ContainerSummaryItem', 'json', $context);
                }
                $values_1[] = $values_2;
            }
        ...
        if (\array_key_exists('Volumes', $data) && $data['Volumes'] !== null) {
            ...
            foreach ($data['Volumes'] as $value_3) {
                $values_3[] = $this->denormalizer->denormalize($value_3, 'Docker\\OpenAPI\\Model\\Volume', 'json', $context);
            }
        ...
        if (\array_key_exists('BuildCache', $data) && $data['BuildCache'] !== null) {
            ...
            foreach ($data['BuildCache'] as $value_4) {
                $values_4[] = $this->denormalizer->denormalize($value_4, 'Docker\\OpenAPI\\Model\\BuildCache', 'json', $context);
            }
