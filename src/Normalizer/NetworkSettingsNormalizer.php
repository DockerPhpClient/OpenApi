...
class NetworkSettingsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Docker\\OpenAPI\\Model\\NetworkSettings';
    }

    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'Docker\\OpenAPI\\Model\\NetworkSettings';
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\OpenAPI\Model\NetworkSettings();
        ...
        if (\array_key_exists('Ports', $data) && $data['Ports'] !== null) {
            ...
            foreach ($data['Ports'] as $key => $value) {
                ...
                foreach ($value as $value_1) {
                    $values_1[] = $this->denormalizer->denormalize($value_1, 'Docker\\OpenAPI\\Model\\PortBinding', 'json', $context);
                }
                $values[$key] = $values_1;
            }
        ...
        if (\array_key_exists('SecondaryIPAddresses', $data) && $data['SecondaryIPAddresses'] !== null) {
            ...
            foreach ($data['SecondaryIPAddresses'] as $value_2) {
                $values_2[] = $this->denormalizer->denormalize($value_2, 'Docker\\OpenAPI\\Model\\Address', 'json', $context);
            }
        ...
        if (\array_key_exists('SecondaryIPv6Addresses', $data) && $data['SecondaryIPv6Addresses'] !== null) {
            ...
            foreach ($data['SecondaryIPv6Addresses'] as $value_3) {
                $values_3[] = $this->denormalizer->denormalize($value_3, 'Docker\\OpenAPI\\Model\\Address', 'json', $context);
            }
        ...
        if (\array_key_exists('Networks', $data) && $data['Networks'] !== null) {
            ...
            foreach ($data['Networks'] as $key_1 => $value_4) {
                $values_4[$key_1] = $this->denormalizer->denormalize($value_4, 'Docker\\OpenAPI\\Model\\EndpointSettings', 'json', $context);
            }
