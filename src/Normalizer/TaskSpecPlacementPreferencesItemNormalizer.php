...
class TaskSpecPlacementPreferencesItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Docker\\OpenAPI\\Model\\TaskSpecPlacementPreferencesItem';
    }

    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'Docker\\OpenAPI\\Model\\TaskSpecPlacementPreferencesItem';
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\OpenAPI\Model\TaskSpecPlacementPreferencesItem();
        if (null === $data || false === \is_array($data)) {
            return $object;
        }
        if (\array_key_exists('Spread', $data) && $data['Spread'] !== null) {
            $object->setSpread($this->denormalizer->denormalize($data['Spread'], 'Docker\\OpenAPI\\Model\\TaskSpecPlacementPreferencesItemSpread', 'json', $context));
