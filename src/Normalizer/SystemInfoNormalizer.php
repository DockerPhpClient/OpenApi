...
class SystemInfoNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Docker\\OpenAPI\\Model\\SystemInfo';
    }

    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'Docker\\OpenAPI\\Model\\SystemInfo';
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\OpenAPI\Model\SystemInfo();
        ...
        if (\array_key_exists('Plugins', $data) && $data['Plugins'] !== null) {
            $object->setPlugins($this->denormalizer->denormalize($data['Plugins'], 'Docker\\OpenAPI\\Model\\PluginsInfo', 'json', $context));
        ...
        if (\array_key_exists('RegistryConfig', $data) && $data['RegistryConfig'] !== null) {
            $object->setRegistryConfig($this->denormalizer->denormalize($data['RegistryConfig'], 'Docker\\OpenAPI\\Model\\RegistryServiceConfig', 'json', $context));
        ...
        if (\array_key_exists('GenericResources', $data) && $data['GenericResources'] !== null) {
            ...
            foreach ($data['GenericResources'] as $value_4) {
                $values_4[] = $this->denormalizer->denormalize($value_4, 'Docker\\OpenAPI\\Model\\GenericResourcesItem', 'json', $context);
            }
        ...
        if (\array_key_exists('Runtimes', $data) && $data['Runtimes'] !== null) {
            ...
            foreach ($data['Runtimes'] as $key => $value_6) {
                $values_6[$key] = $this->denormalizer->denormalize($value_6, 'Docker\\OpenAPI\\Model\\Runtime', 'json', $context);
            }
        ...
        if (\array_key_exists('Swarm', $data) && $data['Swarm'] !== null) {
            $object->setSwarm($this->denormalizer->denormalize($data['Swarm'], 'Docker\\OpenAPI\\Model\\SwarmInfo', 'json', $context));
        ...
        if (\array_key_exists('ContainerdCommit', $data) && $data['ContainerdCommit'] !== null) {
            $object->setContainerdCommit($this->denormalizer->denormalize($data['ContainerdCommit'], 'Docker\\OpenAPI\\Model\\Commit', 'json', $context));
        ...
        if (\array_key_exists('RuncCommit', $data) && $data['RuncCommit'] !== null) {
            $object->setRuncCommit($this->denormalizer->denormalize($data['RuncCommit'], 'Docker\\OpenAPI\\Model\\Commit', 'json', $context));
        ...
        if (\array_key_exists('InitCommit', $data) && $data['InitCommit'] !== null) {
            $object->setInitCommit($this->denormalizer->denormalize($data['InitCommit'], 'Docker\\OpenAPI\\Model\\Commit', 'json', $context));
