...
class ServiceEndpointNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Docker\\OpenAPI\\Model\\ServiceEndpoint';
    }

    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'Docker\\OpenAPI\\Model\\ServiceEndpoint';
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\OpenAPI\Model\ServiceEndpoint();
        if (null === $data || false === \is_array($data)) {
            return $object;
        }
        if (\array_key_exists('Spec', $data) && $data['Spec'] !== null) {
            $object->setSpec($this->denormalizer->denormalize($data['Spec'], 'Docker\\OpenAPI\\Model\\EndpointSpec', 'json', $context));
        ...
        if (\array_key_exists('Ports', $data) && $data['Ports'] !== null) {
            ...
            foreach ($data['Ports'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'Docker\\OpenAPI\\Model\\EndpointPortConfig', 'json', $context);
            }
        ...
        if (\array_key_exists('VirtualIPs', $data) && $data['VirtualIPs'] !== null) {
            ...
            foreach ($data['VirtualIPs'] as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, 'Docker\\OpenAPI\\Model\\ServiceEndpointVirtualIPsItem', 'json', $context);
            }
