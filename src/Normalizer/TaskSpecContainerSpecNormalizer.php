...
class TaskSpecContainerSpecNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Docker\\OpenAPI\\Model\\TaskSpecContainerSpec';
    }

    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'Docker\\OpenAPI\\Model\\TaskSpecContainerSpec';
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\OpenAPI\Model\TaskSpecContainerSpec();
        ...
        if (\array_key_exists('Privileges', $data) && $data['Privileges'] !== null) {
            $object->setPrivileges($this->denormalizer->denormalize($data['Privileges'], 'Docker\\OpenAPI\\Model\\TaskSpecContainerSpecPrivileges', 'json', $context));
        ...
        if (\array_key_exists('Mounts', $data) && $data['Mounts'] !== null) {
            ...
            foreach ($data['Mounts'] as $value_5) {
                $values_5[] = $this->denormalizer->denormalize($value_5, 'Docker\\OpenAPI\\Model\\Mount', 'json', $context);
            }
        ...
        if (\array_key_exists('HealthCheck', $data) && $data['HealthCheck'] !== null) {
            $object->setHealthCheck($this->denormalizer->denormalize($data['HealthCheck'], 'Docker\\OpenAPI\\Model\\HealthConfig', 'json', $context));
        ...
        if (\array_key_exists('DNSConfig', $data) && $data['DNSConfig'] !== null) {
            $object->setDNSConfig($this->denormalizer->denormalize($data['DNSConfig'], 'Docker\\OpenAPI\\Model\\TaskSpecContainerSpecDNSConfig', 'json', $context));
        ...
        if (\array_key_exists('Secrets', $data) && $data['Secrets'] !== null) {
            ...
            foreach ($data['Secrets'] as $value_7) {
                $values_7[] = $this->denormalizer->denormalize($value_7, 'Docker\\OpenAPI\\Model\\TaskSpecContainerSpecSecretsItem', 'json', $context);
            }
        ...
        if (\array_key_exists('Configs', $data) && $data['Configs'] !== null) {
            ...
            foreach ($data['Configs'] as $value_8) {
                $values_8[] = $this->denormalizer->denormalize($value_8, 'Docker\\OpenAPI\\Model\\TaskSpecContainerSpecConfigsItem', 'json', $context);
            }
